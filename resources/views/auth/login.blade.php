...
<head>
  ...
  <body class="bg-light-gray" id="body">
            ...
            <div class="card-header bg-primary">
              <div class="app-brand">
                <a href="/index.html">
                  ...
                  <span class="brand-name">Apps by Elsabe</span>
                </a>
              </div>
            </div>
      ...
      <div class="copyright pl-0">
        <p class="text-center">&copy; 2018 Copyright Apps by
          <a class="text-primary" href="http://www.iamabdus.com/" target="_blank">Elsabe</a>.
        </p>
      </div>
    </div>
</body>
